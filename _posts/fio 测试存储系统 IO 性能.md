...
8. `filename_format`=format：与 `filename` 二选一，这个支持在文件名中包含变量，变量名以 `$` 开头。如果 `filename` 和 `filename_format` 都未设定，就会以 `$jobname.$jobnum.$filenum` 为默认的文件名。
...
9. `thread`=int：fio 的并发线程总数，默认值为 1。

10. `numjobs`=int：fio 并发执行的 job 数量，默认值为 1。
...
note: both iodepth >= 1 and synchronous I/O engine are selected, queue depth will be capped at 1
Jobs: 2 (f=2): [M(2)][100.0%][r=14.5MiB/s,w=13.9MiB/s][r=1856,w=1780 IOPS][eta 00m:00s]
job1: (groupid=0, jobs=2): err= 0: pid=503795: Sun May 28 02:23:36 2023
  read: IOPS=2117, BW=16.5MiB/s (17.3MB/s)(99.2MiB/5996msec)
    clat (usec): min=85, max=8327, avg=447.76, stdev=1549.03
     lat (usec): min=85, max=8327, avg=447.82, stdev=1549.03
    clat percentiles (usec):
     |  1.00th=[   90],  5.00th=[   93], 10.00th=[   95], 20.00th=[   97],
     | 30.00th=[   99], 40.00th=[  101], 50.00th=[  103], 60.00th=[  106],
     | 70.00th=[  111], 80.00th=[  118], 90.00th=[  147], 95.00th=[  474],
     | 99.00th=[ 7767], 99.50th=[ 7832], 99.90th=[ 7963], 99.95th=[ 8029],
     | 99.99th=[ 8160]
   bw (  KiB/s): min=13792, max=43680, per=100.00%, avg=17137.45, stdev=4303.10, samples=22
   iops        : min= 1724, max= 5460, avg=2142.18, stdev=537.89, samples=22
  write: IOPS=2151, BW=16.8MiB/s (17.6MB/s)(101MiB/5996msec); 0 zone resets
    clat (usec): min=128, max=9083, avg=486.91, stdev=1536.41
     lat (usec): min=128, max=9083, avg=487.02, stdev=1536.41
    clat percentiles (usec):
     |  1.00th=[  135],  5.00th=[  137], 10.00th=[  139], 20.00th=[  143],
     | 30.00th=[  145], 40.00th=[  147], 50.00th=[  151], 60.00th=[  155],
     | 70.00th=[  159], 80.00th=[  167], 90.00th=[  190], 95.00th=[  420],
     | 99.00th=[ 7832], 99.50th=[ 7898], 99.90th=[ 8029], 99.95th=[ 8094],
     | 99.99th=[ 8455]
   bw (  KiB/s): min=13904, max=46240, per=100.00%, avg=17499.64, stdev=4657.33, samples=22
   iops        : min= 1738, max= 5780, avg=2187.45, stdev=582.17, samples=22
  lat (usec)   : 100=18.91%, 250=74.82%, 500=1.41%, 750=0.28%, 1000=0.09%
  lat (msec)   : 2=0.05%, 4=0.05%, 10=4.39%
  cpu          : usr=0.38%, sys=1.34%, ctx=25602, majf=0, minf=0
...
Run status group 0 (all jobs):
   READ: bw=16.5MiB/s (17.3MB/s), 16.5MiB/s-16.5MiB/s (17.3MB/s-17.3MB/s), io=99.2MiB (104MB), run=5996-5996msec
  WRITE: bw=16.8MiB/s (17.6MB/s), 16.8MiB/s-16.8MiB/s (17.6MB/s-17.6MB/s), io=101MiB (106MB), run=5996-5996msec

Disk stats (read/write):
  vda: ios=12352/12566, merge=0/0, ticks=5399/6061, in_queue=11460, util=98.36%
```
...
$ du -sh *
4.0K    jobfile.fio
100M    mytestfile-job1-0-0
100M    mytestfile-job1-1-0
```
