...
安装快照 RPC 总结。快照被分割成块进行传输，这为追随者提供了每个块的生命迹象，因此它可以重置其选举计时器。

![图 13：。](https://gukaifeng.cn/posts/raft-lun-wen-yue-du-bi-ji/Raft_Figure_13.png)



领导者使用名为**安装快照(InstallSnapshot)**的新 RPC 将快照发送给落后太远的追随者，见图 13。
